...
def generate_combinations(start_coords, end_coords, nearest_start_stations, nearest_end_stations, mrt_stations):
    combinations = []
    ...
    return combinations[:3]  # Select top 3 combinations
...
# Generate combinations and their heuristic distances
top_combinations = generate_combinations(start_coords, end_coords, nearest_start_stations, nearest_end_stations, mrt_stations)
