...
from postal_code_utils import get_coordinates  # Import the postal code utility
        ...
        if mode == 'mrt':
            ...
            if not start or not end:
                if self.start_postal_entry.text() and self.end_postal_entry.text():
                    start_coords = get_coordinates(self.start_postal_entry.text())
                    end_coords = get_coordinates(self.end_postal_entry.text())
                    if start_coords and end_coords:
                        ...
                        QMessageBox.critical(self, "Input Error", "Unable to convert postal codes to coordinates.")
                        return
                else:
                    QMessageBox.critical(self, "Input Error", "Please set valid start and end points on the map or enter valid postal codes.")
                    return
            else:
